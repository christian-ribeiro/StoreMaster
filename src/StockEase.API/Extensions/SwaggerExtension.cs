...
namespace StockEase.API.Extensions
{
    public static class SwaggerExtension
    {
        public static IServiceCollection ConfigureSwagger(this IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "StockEase API", Version = "v1" });
        ...
        public static WebApplication ApplySwagger(this WebApplication app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "StockEase API v1");
                c.DocumentTitle = "StockEase API Documentation";
                c.EnableFilter();
